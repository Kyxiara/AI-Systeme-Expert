...
; Base de faits :
(setf (symptome-intensité douleur) 3)

(setq liste_symptomes (list 'rougeur 'difficultes_respiratoire 'douleur))
...
(setq  condition_arret '(atom liste_regles_en_conflit))
...
(loop
    ...
    (when (eval condition_arret) (return nil))
